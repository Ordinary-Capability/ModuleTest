...
#define FINSH_THREAD_STACK_SIZE 16000
...
#define RT_LWIP_TCP_SND_BUF 24576
...
/* CONFIG_CONFIG_CHIP_FH8632 is not set */
/* CONFIG_CONFIG_CHIP_FH8620H is not set */
/* CONFIG_CONFIG_CHIP_FH8830 is not set */
/* CONFIG_CONFIG_CHIP_FH8630M is not set */
/* CONFIG_CONFIG_CHIP_FH8630 is not set */
#define CONFIG_CHIP_FH8856
/* CONFIG_CONFIG_CHIP_FH8852 is not set */
/* CONFIG_FH_FAST_BOOT is not set */
/* CONFIG_CONFIG_BOARD_APP is not set */
#define CONFIG_BOARD_TEST
/* CONFIG_CONFIG_BOARD_FPGA is not set */
/* CONFIG_CONFIG_BOARD_FAST is not set */
...
/* CONFIG_RT_USING_COMPONENTS_RSHELL is not set */
