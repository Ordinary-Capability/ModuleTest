...
struct serial_configure g_uart_conf_set[] = {
    ...
    {BAUD_RATE_9600, DATA_BITS_8, STOP_BITS_1, PARITY_NONE, BIT_ORDER_LSB, NRZ_NORMAL, RT_SERIAL_RB_BUFSZ, 0},
    {BAUD_RATE_19200, DATA_BITS_8, STOP_BITS_1, PARITY_NONE, BIT_ORDER_LSB, NRZ_NORMAL, RT_SERIAL_RB_BUFSZ, 0},
    {BAUD_RATE_38400, DATA_BITS_8, STOP_BITS_1, PARITY_NONE, BIT_ORDER_LSB, NRZ_NORMAL, RT_SERIAL_RB_BUFSZ, 0},
    ...
    {BAUD_RATE_115200, DATA_BITS_8, STOP_BITS_1, PARITY_ODD, BIT_ORDER_LSB, NRZ_NORMAL, RT_SERIAL_RB_BUFSZ, 0},
