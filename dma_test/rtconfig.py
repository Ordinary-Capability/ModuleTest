...
OUTPUT_DISNAME = OUTPUT_NAME + '.dis'
OUTPUT_MAPNAME = OUTPUT_NAME + '.map'
...
if CROSS_TOOL == 'gcc':
    ...
    #PLATFORM_DEF = [os.environ['SCONS_PLATFORM_DEF']]
...
if PLATFORM == 'gcc':
    ...
    LFLAGS = DEVICE + ' -Wl,--gc-sections,-Map='+ OUTPUT_MAPNAME +',-cref,-u,_start -T' + LD_NAME +'.ld' + ' -Ttext ' + TextBase
    CPATH = ''
    LPATH = ''
    if BUILD == 'debug':
        CFLAGS += ' -O0 -gdwarf-2 '
    ...
    POST_ACTION += OBJDUMP + ' -d  $TARGET > '+ OUTPUT_DISNAME +'\n'
